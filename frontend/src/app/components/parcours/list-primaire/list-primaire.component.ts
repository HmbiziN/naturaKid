...
@Component({
  selector: 'app-list-primaire',
  templateUrl: './list-primaire.component.html',
  styleUrls: ['./list-primaire.component.css']
})
export class ListPrimaireComponent implements OnInit {
