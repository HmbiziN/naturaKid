...
export class ListLabelComponent implements OnInit {
  ...
  public label: string= "true"
  public ifLabel: boolean= true
  ...
  ngOnInit(): void {
    ...
    this.filterIteneraryByLabelTrue(this.map)
  }
  ...
  public selectLabelTrue(){
    this.label = "true"
    this.ifLabel = true
  }
  public selectLabelFalse(){
    this.label = "false"
    this.ifLabel = false
  }
  ...
  public updateFilterWhithLabel(filtre: number, complexity: number, label : string){
    this.mapService.filterMultiple(filtre, complexity, label)
    .subscribe((response: LAUFEN.Itinerary[])=>{
      this.itenerary = response
    })
  }
  ...
  public getItineraryWithFilter(){
    this.updateFilterWhithLabel(this.filterAge, this.filterComplexity, this.label)
  }
