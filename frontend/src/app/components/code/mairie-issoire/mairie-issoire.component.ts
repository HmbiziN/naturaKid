...
@Component({
  selector: 'app-mairie-issoire',
  templateUrl: './mairie-issoire.component.html',
  styleUrls: ['./mairie-issoire.component.css']
})
export class MairieIssoireComponent implements OnInit {
