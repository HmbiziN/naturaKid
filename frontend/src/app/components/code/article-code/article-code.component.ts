...
@Component({
  selector: 'app-article-code',
  templateUrl: './article-code.component.html',
  styleUrls: ['./article-code.component.css']
})
export class ArticleCodeComponent implements OnInit {
